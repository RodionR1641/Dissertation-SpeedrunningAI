...
class LivePlot():
    ...
    def __init__(self):
        ...
        self.ax.set_title("Average Loss over epochs")
    ...
    def update_plot(self,stats):
        self.data = stats["AverageLoss"] #what the log file will basically have
        ...
        self.ax.plot(self.data, "b-", label="Average Loss") #blue line
